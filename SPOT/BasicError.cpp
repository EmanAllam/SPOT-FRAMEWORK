...
{
	ostringstream stream;
	stream << "Invalid Study Plan: Semster " << invalidSem << " Year "<< invalidYear << " has unmet dependencies. (" << severity << ")";
	error_msg = stream.str();
}
...
{
	ostringstream stream;
	stream << "Invalid Study Plan: the Program" << " has unmet dependencies. (" << severity << ")";
	error_msg = stream.str();
}
...
{
	ostringstream stream;
	stream << "Invalid Study Plan: the Concentration" << " has unmet dependencies. (" << severity << ")";
	error_msg = stream.str();
}
